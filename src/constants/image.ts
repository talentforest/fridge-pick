...
export const ingredientImagesObj: {
  [key in CategoryKey]: { [key in string]: ImageSourcePropType };
} = {
  noodle: {
  ...
  // 간식/베이커리
  desert: {
    castella: require('../../assets/images/ingredients/desert/castella.png'),
    whole_cake: require('../../assets/images/ingredients/desert/whole_cake.png'),
    honey_rice_cake: require('../../assets/images/ingredients/desert/honey_rice_cake.png'),
    garaetteok: require('../../assets/images/ingredients/desert/garaetteok.png'),
    dried_persimmon: require('../../assets/images/ingredients/desert/dried_persimmon.png'),
    nachos: require('../../assets/images/ingredients/desert/nachos.png'),
    red_bean_bread: require('../../assets/images/ingredients/desert/red_bean_bread.png'),
    donut: require('../../assets/images/ingredients/desert/donut.png'),
    strawberry_jam: require('../../assets/images/ingredients/desert/strawberry_jam.png'),
    roll_cake: require('../../assets/images/ingredients/desert/roll_cake.png'),
    garlic_bread: require('../../assets/images/ingredients/desert/garlic_bread.png'),
    marshmallow: require('../../assets/images/ingredients/desert/marshmallow.png'),
    muffin: require('../../assets/images/ingredients/desert/muffin.png'),
    dinner_roll: require('../../assets/images/ingredients/desert/dinner_roll.png'),
    baguette: require('../../assets/images/ingredients/desert/baguette.png'),
    bagel: require('../../assets/images/ingredients/desert/bagel.png'),
    salt_bread: require('../../assets/images/ingredients/desert/salt_bread.png'),
    sandwich_cookie: require('../../assets/images/ingredients/desert/sandwich_cookie.png'),
    sandwich_bread: require('../../assets/images/ingredients/desert/sandwich_bread.png'),
    cinnamon_roll: require('../../assets/images/ingredients/desert/cinnamon_roll.png'),
    rice_cracker: require('../../assets/images/ingredients/desert/rice_cracker.png'),
    ice_cream_bar: require('../../assets/images/ingredients/desert/ice_cream_bar.png'),
    ice_cream_tub: require('../../assets/images/ingredients/desert/ice_cream_tub.png'),
    yokan: require('../../assets/images/ingredients/desert/yokan.png'),
    energy_bar: require('../../assets/images/ingredients/desert/energy_bar.png'),
    oranda: require('../../assets/images/ingredients/desert/oranda.png'),
    omegi_tteok: require('../../assets/images/ingredients/desert/omegi_tteok.png'),
    yugwa: require('../../assets/images/ingredients/desert/yugwa.png'),
    injeolmi: require('../../assets/images/ingredients/desert/injeolmi.png'),
    jelly: require('../../assets/images/ingredients/desert/jelly.png'),
    cake_slice: require('../../assets/images/ingredients/desert/cake_slice.png'),
    steamed_bun: require('../../assets/images/ingredients/desert/steamed_bun.png'),
    chapssal_tteok: require('../../assets/images/ingredients/desert/chapssal_tteok.png'),
    choco_bar: require('../../assets/images/ingredients/desert/choco_bar.png'),
    chocolate: require('../../assets/images/ingredients/desert/chocolate.png'),
    chocolate_bar: require('../../assets/images/ingredients/desert/chocolate_bar.png'),
    chips: require('../../assets/images/ingredients/desert/chips.png'),
    caramel: require('../../assets/images/ingredients/desert/caramel.png'),
    cookie: require('../../assets/images/ingredients/desert/cookie.png'),
    cracker: require('../../assets/images/ingredients/desert/cracker.png'),
    croissant: require('../../assets/images/ingredients/desert/croissant.png'),
    tart: require('../../assets/images/ingredients/desert/tart.png'),
    pie: require('../../assets/images/ingredients/desert/pie.png'),
    pancake: require('../../assets/images/ingredients/desert/pancake.png'),
    grape_jam: require('../../assets/images/ingredients/desert/grape_jam.png'),
    pudding: require('../../assets/images/ingredients/desert/pudding.png'),
    pretzel: require('../../assets/images/ingredients/desert/pretzel.png'),
    hangwa: require('../../assets/images/ingredients/desert/hangwa.png'),
    rye_bread: require('../../assets/images/ingredients/desert/rye_bread.png'),
    black_sesame_tteok: require('../../assets/images/ingredients/desert/black_sesame_tteok.png'),
    peanut_butter: require('../../assets/images/ingredients/desert/peanut_butter.png'),
    popcorn: require('../../assets/images/ingredients/desert/popcorn.png'),
  },
